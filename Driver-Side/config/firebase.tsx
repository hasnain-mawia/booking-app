...
import { collection, addDoc, getFirestore, query, where, onSnapshot, doc, updateDoc } from "firebase/firestore";
...
const rideRequest = (ride: any) => {
    console.log('ride', ride)
    return addDoc(collection(db, "rides"), ride);
}

const updateRequest = async () => {
    const Status = doc(db, "rides", "status");
